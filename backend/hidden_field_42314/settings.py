"""
Django settings for hidden_field_42314 project.
...
ROOT_URLCONF = 'hidden_field_42314.urls'
...
WSGI_APPLICATION = 'hidden_field_42314.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hidden_field_42314 API",
    "DESCRIPTION": "API documentation for hidden_field_42314 App",
    "VERSION": "v1",
}
